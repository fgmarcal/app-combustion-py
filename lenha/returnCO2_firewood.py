...
def returnCO2FromExcessAir_firewood(x):
    return p(x)

# Exemplo de uso
x = eval(input('informe o valor do excesso de ar: '))
resultado = returnCO2FromExcessAir_firewood(x)
print(resultado)