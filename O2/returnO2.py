...
def returnO2FromExcessAir(x):
    return p(x)
# Exemplo de uso
x = eval(input('informe o valor do excesso de ar: '))
resultado = returnO2FromExcessAir(x)
print(resultado)
